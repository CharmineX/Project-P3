            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="<?php echo BASE_URL . "/assets/images/chirpify-logo.png"; ?>" alt="bird">
                        ...
                        <span class="join">Join Chirpify Today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <section class="twt-features">
                <div class="features-div">
                    ...
                    <p>Follow your interests and create memes all you want.</p>
                    <img class="twt-icon" src="https://image.ibb.co/mZPTWU/heart_icon.png">
                    <p>Hear what people are talking about, even if they are boring.</p>
            ...
            <footer>
                <ul>
                    <li><a href="#">Copyright Shivam Boedhram, Abdilatif Ahmad, Kaj Put</a></li>
                    </li>
                </ul>
            </footer>
        </main>
